...
const SLIDES: Slide[] = [
  {
    id: "hero-building",
    src: "/images/gallery/hero-building.png",
  ...
  {
    id: "campus-shot",
    src: "/images/gallery/campus-shot.png",
  ...
  return (
    ...
    >
      ...
      <motion.button
        ...
        className="absolute bottom-24 left-1/2 z-20 hidden -translate-x-1/2 cursor-pointer flex-col items-center gap-3"
      >
